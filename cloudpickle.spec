...
%prep
%setup -q -n cloudpickle-1.3.0
cd %{_builddir}/cloudpickle-1.3.0
...
cp %{_builddir}/cloudpickle-1.3.0/LICENSE %{buildroot}/usr/share/package-licenses/cloudpickle/1714ccb2a2ccbaa4fdd69680f0406848451a7f41
