...
Version  : 2.2.1
Release  : 59
URL      : https://github.com/cloudpipe/cloudpickle/archive/v2.2.1/cloudpickle-2.2.1.tar.gz
Source0  : https://github.com/cloudpipe/cloudpickle/archive/v2.2.1/cloudpickle-2.2.1.tar.gz
...
%prep
%setup -q -n cloudpickle-2.2.1
cd %{_builddir}/cloudpickle-2.2.1
pushd ..
cp -a cloudpickle-2.2.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674145555
