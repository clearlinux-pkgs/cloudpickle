...
Source0  : https://github.com/cloudpipe/cloudpickle/archive/v1.5.0/cloudpickle-1.5.0.tar.gz
...
%prep
%setup -q -n cloudpickle-1.5.0
cd %{_builddir}/cloudpickle-1.5.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1593636230
...
cp %{_builddir}/cloudpickle-1.5.0/LICENSE %{buildroot}/usr/share/package-licenses/cloudpickle/1714ccb2a2ccbaa4fdd69680f0406848451a7f41
