...
Source0  : https://github.com/cloudpipe/cloudpickle/archive/v1.4.1/cloudpickle-1.4.1.tar.gz
...
%prep
%setup -q -n cloudpickle-1.4.1
cd %{_builddir}/cloudpickle-1.4.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588181018
...
cp %{_builddir}/cloudpickle-1.4.1/LICENSE %{buildroot}/usr/share/package-licenses/cloudpickle/1714ccb2a2ccbaa4fdd69680f0406848451a7f41
